...
def create_tables(cur):
    cur.execute("CREATE TABLE UserAccount(AccountNumber INTEGER PRIMARY KEY AUTOINCREMENT, Username VARCHAR(20), Password VARCHAR(64), SecurityQuestion VARCHAR(35), SecurityAnswer VARCHAR(20), FirstName VARCHAR(15), Age INTEGER, CommutePath VARCHAR(50))");
